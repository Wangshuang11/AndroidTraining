...
public class EnglishFragment extends Fragment implements View.OnClickListener{
    ...
    //所有搜索条件(默认值设置)
    private String subject ="英语";//选中的学科
    private String tag = "听力";
    ...
    // 可用于传值
    public static EnglishFragment newInstance(String title) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.ylx_english_fragment_layout, container, false);
        getViews(view);
        setData();
        setGridView();
        InitData();
