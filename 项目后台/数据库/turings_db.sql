...
CREATE TABLE `tbl_comment` (
  ...
  `dj_icon` varchar(50) DEFAULT 'daxuesheng',
  `dj_name` varchar(100) DEFAULT '大学三年级',
  `content` varchar(1024) DEFAULT NULL,
  `num` varchar(50) DEFAULT '0',
...
-- ----------------------------
INSERT INTO `tbl_comment` VALUES ('1', 'http://jxy2019.oss-cn-beijing.aliyuncs.com/avatars/nv.png', 'Hello', 'daxuesheng', '大学一年级', '坚持就是胜利', '114', '2019-12-05');
INSERT INTO `tbl_comment` VALUES ('2', 'http://jxy2019.oss-cn-beijing.aliyuncs.com/avatars/i1t1587985046457.png', '好先生', 'gaozhongsheng', '高中三年级', 'The same to you', '122', '2020-12-04');
INSERT INTO `tbl_comment` VALUES ('3', 'http://jxy2019.oss-cn-beijing.aliyuncs.com/avatars/i1t1587985046457.png', '王大爽', 'daxuesheng', '大学三年级', 'good', '2', '2020-05-15');
